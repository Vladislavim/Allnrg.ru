...
(function(){
  ...
  const items    = Array.from(strip.querySelectorAll('.case-ko__gallery-item'));
...
(function(){
  document.addEventListener('DOMContentLoaded', function(){
    document.querySelectorAll('.plk-tab').forEach(function(block){

      /* SLIDER */
      (function(){
        const slider   = block.querySelector('.plk-tab__slider');
        if (!slider) return;

        const track    = slider.querySelector('.plk-tab__slider-track');
        const slides   = Array.from(slider.querySelectorAll('.plk-tab__slide'));
        const prevBtn  = slider.querySelector('.plk-tab__nav--prev');
        const nextBtn  = slider.querySelector('.plk-tab__nav--next');
        const dotsWrap = slider.querySelector('.plk-tab__dots');
      ...
      /* GALLERY + LIGHTBOX */
      (function(){
        const strip    = block.querySelector('.plk-tab__gallery-strip');
        const lightbox = block.querySelector('.plk-tab__lightbox');
        if (!strip || !lightbox) return;

        const items    = Array.from(strip.querySelectorAll('.plk-tab__gallery-item'));
        const imgEl    = lightbox.querySelector('img');
        const closeBtn = lightbox.querySelector('.plk-tab__lightbox-close');
        const backdrop = lightbox.querySelector('.plk-tab__lightbox-backdrop');
...
(function(){
  document.addEventListener('DOMContentLoaded', function(){
    document.querySelectorAll('.plk-mob').forEach(function(block){

      /* SLIDER */
      (function(){
        const slider   = block.querySelector('.plk-mob__slider');
        if (!slider) return;

        const track    = slider.querySelector('.plk-mob__slider-track');
        const slides   = Array.from(slider.querySelectorAll('.plk-mob__slide'));
        const prevBtn  = slider.querySelector('.plk-mob__nav--prev');
        const nextBtn  = slider.querySelector('.plk-mob__nav--next');
        const dotsWrap = slider.querySelector('.plk-mob__dots');
      ...
      /* GALLERY + LIGHTBOX */
      (function(){
        const strip    = block.querySelector('.plk-mob__gallery-strip');
        const lightbox = block.querySelector('.plk-mob__lightbox');
        if (!strip || !lightbox) return;

        const items    = Array.from(strip.querySelectorAll('.plk-mob__gallery-item'));
        const imgEl    = lightbox.querySelector('img');
        const closeBtn = lightbox.querySelector('.plk-mob__lightbox-close');
        const backdrop = lightbox.querySelector('.plk-mob__lightbox-backdrop');
